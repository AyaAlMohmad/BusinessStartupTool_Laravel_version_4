    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
        ...
        <ul class="navbar-nav  justify-content-end">
            ...
            <li class="nav-item px-3 d-flex align-items-center">
                <a href="javascript:;" class="nav-link text-body p-0 fixed-plugin-button">
                    <svg width="16" height="16" xmlns="http://www.w3.org/2000/svg"
                        class="cursor-pointer" viewBox="0 0 24 24"
                        fill="currentColor">
            ...
            <li class="nav-item dropdown pe-3 d-flex align-items-center">
                <a class="nav-link text-white p-0" href="#" id="languageDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    @if(app()->getLocale() == 'ar')
                        <span class="flag-icon flag-icon-eg"></span> العربية
                    @else
                        <span class="flag-icon flag-icon-gb"></span> English
                    @endif
                    <i class="fa fa-chevron-down ms-1 text-white"></i>
                </a>
                <ul class="dropdown-menu dropdown-menu-end px-2 py-2" aria-labelledby="languageDropdown">
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ url()->current() }}?lang=ar">
                            <span class="flag-icon flag-icon-eg me-2"></span>
                            <span>العربية</span>
                        </a>
                    </li>
                    <li>
            ...
            <li class="nav-item dropdown d-flex align-items-center position-relative">
                <a href="javascript:;" class="nav-link text-white p-0 d-flex align-items-center" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="position-relative me-2">
                        <img src="{{ Auth::user()->profile_image ? asset(Auth::user()->profile_image) : asset('assets/img/profile.jpeg') }}"
