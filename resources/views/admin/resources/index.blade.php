            ...
            <div class="card border shadow-xs mb-4">
                <div class="card-header border-bottom pb-0">
                    <div class="d-sm-flex align-items-center mb-3">
                        <div>
                            <h6 class="font-weight-semibold text-lg mb-0">Resources List</h6>
                            <p class="text-sm mb-sm-0">Manage your resources</p>
                        </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2">
                                                <div class="my-auto">
                                                    <h6 class="mb-0 text-sm">{{ $resource->title }}</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="{{ route('admin.resources.edit', $resource->id) }}"
                                                ...
                                                data-bs-toggle="tooltip" data-bs-title="Edit resource">
                                            ...
                                            <form action="{{ route('admin.resources.destroy', $resource->id) }}"
                                                ...
                                                <button type="submit"
                                                    ...
                                                    data-bs-toggle="tooltip" data-bs-title="Delete resource"
                                                    onclick="return confirm('Are you sure you want to delete this resource?')">
                                                    <svg width="14" height="14" viewBox="0 0 16 16" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path
                                                            d="M5.33398 3.99992V2.66659C5.33398 2.31296 5.47446 1.97382 5.72451 1.72378C5.97455 1.47373 6.31369 1.33325 6.66732 1.33325H9.33398C9.68761 1.33325 10.0268 1.47373 10.2768 1.72378C10.5268 1.97382 10.6673 2.31296 10.6673 2.66659V3.99992M12.6673 3.99992H3.33398L4.00065 13.3333C4.00065 13.8637 4.21136 14.3724 4.58644 14.7475C4.96151 15.1225 5.47022 15.3333 6.00065 15.3333H10.0006C10.5311 15.3333 11.0398 15.1225 11.4149 14.7475C11.7899 14.3724 12.0006 13.8637 12.0006 13.3333L12.6673 3.99992Z"
                        ...
                        <nav aria-label="..." class="ms-auto">
                            <ul class="pagination pagination-light mb-0">
                                @foreach ($resources->getUrlRange(1, $resources->lastPage()) as $page => $url)
                                    <li class="page-item {{ $resources->currentPage() == $page ? 'active' : '' }}">
