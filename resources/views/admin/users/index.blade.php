                        ...
                        <table class="table align-items-center justify-content-center mb-0">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="text-secondary text-xs font-weight-semibold opacity-7 ps-2">Responsibility
                                    </th>
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="email" class="form-control"
                                                                                ...
                                                                                required>
                                                                            <small class="text-muted">User's primary email
                                                                                address</small>
                                                                            @error('email')
                                                                                <div class="text-danger small">
                                                                                    {{ $message }}</div>
                                                                       ...
                                                                       {{-- بدّل الشرط --}}
{{-- السماح للمسؤولين بتغيير كلمة السر --}}
<!--@if (auth()->user()->is_admin)-->
<div class="mb-3">
    <label for="password-{{ $user->id }}" class="form-label fw-bold">New Password</label>
    <div class="password-field position-relative">
        <input type="password" class="form-control pe-5" id="password-{{ $user->id }}" name="password"
               placeholder="Leave blank to keep current">
        <button type="button"
                class="btn btn-link password-toggle position-absolute end-0 top-50 translate-middle-y me-3 text-decoration-none">
            <i class="fas fa-eye"></i>
        </button>
    </div>
    @error('password')
...
<div class="mb-3">
    <label for="password_confirmation-{{ $user->id }}" class="form-label fw-bold">Confirm Password</label>
    <div class="password-field position-relative">
        <input type="password" class="form-control pe-5" id="password_confirmation-{{ $user->id }}"
...
<!--@endif-->
                                                                        ...
                                                                        <!-- Region -->
                                                                        <div class="mb-3">
                                                                            <label for="region_id-{{ $user->id }}"
                                                                                class="form-label fw-bold">Region</label>
                                                                            <select class="form-select"
                                                                                id="region_id-{{ $user->id }}"
                                                                                name="region_id">
                                                                            ...
                                                                            <small class="text-muted">User's primary
                                                                                region</small>
                                                                            @error('region_id')
                                                                                <div class="text-danger small">
                                                                                    {{ $message }}</div>
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="status-{{ $user->id }}"
                                                                                class="form-label fw-bold">Account
                                                                                Status</label>
                                                                            <select class="form-select"
                                                                                id="status-{{ $user->id }}"
                                                                        ...
                                                                        <!-- Admin Status -->
                                                                        <div class="mb-3">
                                                                            <label for="is_admin-{{ $user->id }}"
                                                                                class="form-label fw-bold">Admin
                                                                                Privileges</label>
                                                                            <select class="form-select"
                                                                                id="is_admin-{{ $user->id }}"
                                                                        ...
                                                                        <!-- Role -->
                                                                        <div class="mb-3">
                                                                            <label for="role_ids-{{ $user->id }}"
                                                                                class="form-label fw-bold">User
                                                                                Responsibility (Roles)</label>
                                                                            <select class="form-select"
                                                                                id="role_ids-{{ $user->id }}"
                                                                                name="role_ids[]" multiple>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // إضافة وظيفة إظهار/إخفاء لكافة أزرار العين
            ...
            // تفعيل زر العين عند فتح المودال
    ...
    <style>
        ...
        /* تنسيق حقل كلمة المرور مع زر العين */
        .password-field {
            position: relative;
        }
