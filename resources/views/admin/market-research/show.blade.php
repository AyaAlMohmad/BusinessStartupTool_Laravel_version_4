...
$fieldNames = [
    ...
    'other' => 'Other',
    'education' => 'Add more Persona Information',
    'must_have_solutions' => 'Must-Have Solutions',
    'should_have_solutions' => 'Should-Have Solutions',
    'nice_to_have_solutions' => 'Nice-to-Have Solutions',
    'help_persona' => 'I help who has by providing them with',
  ...
  <div class="col-12 col-xxl-10 mx-auto">
    <div class="card shadow-xs">
      <div class="card-header d-flex align-items-center justify-content-between">
        <div>
          <h5 class="mb-1">
            Marketing Research Idea Details
            <span class="badge badge-key">#{{ $research->id }}</span>
          </h5>
      ...
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="lastModifiedTable" class="table table-sm align-middle mb-4">
            ...
            <tbody>
              @foreach ($research->getAttributes() as $key => $newValue)
                @php
...
<script>
  $(function () {
    ...
    $('#exportLastExcel').on('click', function(e){
      ...
      XLSX.writeFile(wb, 'marketing_research_last_modified.xlsx');
    });
    ...
    $('#exportLastPDF').on('click', function(e){
      ...
      doc.text('Marketing Research — Last Modified', 40, 40);
      doc.autoTable({ html:'#lastModifiedTable', startY:60, styles:{fontSize:8} });
      doc.save('marketing_research_last_modified.pdf');
    });
    ...
    $('#exportLogsPDF').on('click', function(e){
      ...
      const doc = new jsPDF('p','pt');
      let y = 40;
      doc.text('Marketing Research — Change Logs (expanded)', 40, y);
      y += 20;
      ...
      setTimeout(function(){
        ...
        doc.save('marketing_research_change_logs.pdf');
