...
<style>
    ...
    .cell-scroll{max-height:150px;overflow:auto}
</style>
        ...
        <div class="card border shadow-xs mb-4">
            <div class="card-header border-bottom pb-0">
                <div class="d-sm-flex align-items-center mb-3">
                    <div>
                        <h6 class="font-weight-semibold text-lg mb-0">Financial Planners List</h6>
                        <p class="text-sm mb-sm-0">Manage linked planners and notes</p>
                    </div>
                    <div class="ms-auto d-flex">
                        ...
                        <div class="btn-group ms-2">
                            <a href="{{ route('admin.financial_planners.analysis') }}" class="btn btn-sm btn-dark">
            ...
            <div class="card-body px-0 py-0">
                        ...
                        <tbody>
                            @foreach ($planners as $business)
                                <tr>
                                    ...
                                    <td><p class="text-sm mb-0">{{ $business->business->name ?? '' }}</p></td>
                                    <td>
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="d-flex justify-content-center">
                                            ...
                                            <a href="{{ route('admin.financial_planners.show', $business->id) }}"
                                               ...
                                               data-bs-toggle="tooltip" data-bs-title="View Planner">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <!-- Delete -->
                                            <form action="{{ route('admin.financial_planners.destroy', $business->id) }}" method="POST" class="m-0">
                                                @csrf @method('DELETE')
                                                <button type="submit"
                                                        ...
                                                        data-bs-toggle="tooltip" data-bs-title="Delete Planner">
                ...
                <div class="border-top py-3 px-3 d-flex align-items-center">
                    @if ($planners->previousPageUrl())
                        <a href="{{ $planners->previousPageUrl() }}" class="btn btn-sm btn-white d-sm-block d-none mb-0">Previous</a>
                    @else
                    ...
                    <nav aria-label="..." class="ms-auto">
                        <ul class="pagination pagination-light mb-0">
                            @foreach ($planners->getUrlRange(1, $planners->lastPage()) as $page => $url)
                                <li class="page-item {{ $planners->currentPage() == $page ? 'active' : '' }}">
                    ...
                    @if ($planners->nextPageUrl())
                        <a href="{{ $planners->nextPageUrl() }}" class="btn btn-sm btn-white d-sm-block d-none mb-0 ms-auto">Next</a>
                    @else
...
<script>
    $(function () {
        $('#exportExcel').on('click', function (e) {
            ...
            XLSX.utils.book_append_sheet(wb, ws, 'FinancialPlanners');
            XLSX.writeFile(wb, 'financial_planners.xlsx');
        });
        ...
        $('#exportPDF').on('click', function (e) {
            ...
            doc.save('financial_planners.pdf');
        });
